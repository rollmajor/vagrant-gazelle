...
// Main settings //
define('SITE_NAME', 'Empornium'); //The name of your site
define('NONSSL_SITE_URL', 'http://127.0.0.1:5000'); //The FQDN of your site
...
define('SERVER_ROOT', '/var/www/app'); //The root of the server, used for includes, purpose is to shorten the path string
...
define('SQLPASS', 'root'); //The MySQL password
...
$AutoAwardTypes  = array ('NumPosts', 'NumComments', 'NumUploaded', 'NumNewTags', 'NumTags', 'NumTagVotes',
                  'RequestsFilled', 'UploadedTB', 'DownloadedTB', 'MaxSnatches','NumBounties');
